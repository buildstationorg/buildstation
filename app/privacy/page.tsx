...
export default function Page() {
  return (
    <div className="flex flex-col gap-8">
      ...
      <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">
        As a visitor to the buildstation.org website
      </h4>
      <p>
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <li>
          No information is mined and harvested for personal and behavioral
          trends
        </li>
        <li>
          No information is mined and harvested for personal and behavioral
      ...
      <p>
        We run the Plausible Analytics script to collect some anonymous usage
        data for statistical purposes. The goal is to track overall trends in
        our website traffic, it is not to track individual visitors. All the
        data is in aggregate only. No personal data is collected.
      </p>
      <p>
        ...
        browser) used during the visit and more.
      </p>
      <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0">
