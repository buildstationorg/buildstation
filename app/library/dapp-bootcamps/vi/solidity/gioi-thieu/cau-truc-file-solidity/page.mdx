...
<PageNav 
    backward={{
        title: "Blockchain", 
        slug: "/library/dapp-bootcamps/vi/solidity/gioi-thieu/blockchain" 
    }}
    
    forward={{
        title: "Cấu trúc smart contract",
        slug: "/library/dapp-bootcamps/vi/solidity/gioi-thieu/cau-truc-smart-contract" 
    }}
/>