  ...
  return (
    <div className="flex flex-col gap-24 my-24 w-full items-center">
      ...
      <div className="flex flex-col w-full gap-8">
        ...
        <p>back in 2023, we <code className="relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold">ZxStim</code>, <code className="relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold">Paulus</code> and <code className="relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold">Dylan</code> started a small meet up series concept called BUIDL Station (hope you have heard of it!) in Vietnam. We were tired of the endless low quality meetups, repetitive talking points and no real actions. The series went viral with tons of other communities adopting it. So far, we have hosted over 52 sessions, and many more sessions from other communities.</p>
