...
<Breadcrumb>
  <BreadcrumbList>
    ...
    <BreadcrumbSeparator />
    <BreadcrumbItem>
      <BreadcrumbPage>mini meetup</BreadcrumbPage>
    </BreadcrumbItem>
  </BreadcrumbList>
</Breadcrumb>
...
## sample meetu
- [BUIDL Station meetup](https://lu.ma/BUIDL-station-2024)
- [buildstation build w frens](https://lu.ma/tact0w5t)
- [metapool x kaia build buddies](https://lu.ma/93m3cj1y)