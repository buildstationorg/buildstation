...
## sample program
### Kaia Builder program
- Kaia builder program is a year round bounty program that rewards open source contributors building many things for the Kaia ecosystem.
- Link to the program: [Kaia Builder Program](https://dub.sh/build-on-kaia)
- Program manager: [ZxStim](https://x.com/zxstim)