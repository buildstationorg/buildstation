  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-0">
      <div className="flex flex-col gap-4 w-full md:w-5/6 text-left">
        ...
        <p className="text-md">buildstation enables you to grow and nurture your developer community with powerful onchain dapps.</p>
      </div>
          ...
          <div className="flex flex-col pl-8">
            {menuItems.map((item) => (
              <Link 
                key={item.id} 
                href={item.url}
                className="group relative hover:underline cursor-pointer flex items-center"
              >
