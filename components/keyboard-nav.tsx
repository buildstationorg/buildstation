  ...
  return (
    <div className="hidden lg:flex flex-row gap-12 mt-[128px]">
      <div className="flex flex-col gap-2">
        <button className="border-primary border border-b-2 px-[1px] py-[1px] w-[24px] h-[24px] hover:bg-primary hover:text-secondary">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex flex-row gap-2">
          {keyboardNavItems.map((item) => (
              <button key={item.keyboard} className="border-primary border border-b-2 px-[1px] py-[1px] w-[24px] h-[24px] hover:bg-primary hover:text-secondary">
                {item.keyboard}
              </button>
          ))}
        </div>
        <p>{keyboardNavItems[0].description}</p>
      </div>
      <div className="flex flex-col gap-2">
        <button className="border-primary border border-b-2 px-[1px] py-[1px] w-[24px] h-[24px] hover:bg-primary hover:text-secondary">
          0
